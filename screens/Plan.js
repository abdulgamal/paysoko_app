      ...
      <View style={styles.main}>
        ...
        <View style={styles.head}>
          <View style={styles.spacer}>
            <View style={styles.row}>
              <Text style={styles.big}>Subscription Payment</Text>
        ...
        <View style={styles.cover}>
          <View style={styles.center}>
            ...
            <Text style={styles.big}>No Subscription Plan Found</Text>
            <Text>We couldn't find any Subscription Plan to this account</Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
